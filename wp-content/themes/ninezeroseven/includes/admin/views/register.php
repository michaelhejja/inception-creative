...
<div class="about-wrap wbc-admin-view">
	...
	<div class="feature-section">
		<?php
			...
			if(!$this->is_registered()){
				$html = '<div class="wbc-registered-message">';
				$html .= '<p>'.sprintf(__('Please register your license to unlock the premium plugins and theme demo imports.','ninezeroseven'),admin_url( 'admin.php?page=ninezeroseven-registration' )).'</p>';
				$html .='</div>';
				echo $html;
			}
	...
	<div class="wbc-register-area">
		...
		?>
			...
			<h3><?php esc_html_e('Where To Find Your License Key');?></h3>
